...
import eu.kanade.tachiyomi.ui.mod.GridColumnHelper
...
internal fun LazyLibraryGrid(
    ...
    val finalColumns = GridColumnHelper.getColumnsInt(enhancedGridColumns, columns)
    FastScrollLazyVerticalGrid(
        columns = if (finalColumns == 0) GridCells.Adaptive(128.dp) else GridCells.Fixed(finalColumns),
        modifier = modifier,
